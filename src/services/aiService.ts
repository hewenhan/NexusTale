...
=== LANGUAGE QUALITY: ABSOLUTE BAN ON CLICHÉ ===
Your writing MUST feel handcrafted by a seasoned novelist, NOT generated by AI. STRICTLY FORBIDDEN phrases and patterns (Chinese examples — English equivalents equally banned):
- "命运的齿轮开始转动" / "命运的洪流"
- "不仅仅是…更是…" / "这不仅是…也是…"
- "在这片土地上" / "在这个世界上" (lazy filler openings)
- "悄然翻开" / "悄然改变" / "悄然降临"
- "新的篇章" / "新的征程" / "崭新的篇章"
- "铭刻于…的记忆之中" / "永远铭记"
- "历史的长河" / "岁月的洗礼"
...
- "交织" / "交织在一起" / "命运交织"
- "…的种子" (e.g., "希望的种子", "信任的种子")
- Any sentence shaped as "这一刻，XXX" / "此刻，XXX" (dramatic-pause cliché)
- Any vague, grandiose abstraction that says nothing concrete

Instead: use SPECIFIC, CONCRETE imagery drawn from the actual worldview, locations, and characters. Prefer sharp sensory details over abstract declarations. Show, don't proclaim. Every sentence must carry NEW information — if a sentence could be copy-pasted into any other story unchanged, delete it and write something only THIS story could contain.
